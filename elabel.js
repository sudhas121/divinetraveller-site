...
// version 1.8      remove the old GMarkerManager support due to clashes with v2.143
      ...
      function ELabel(point, html, classname, pixelOffset, percentOpacity, overlap) {
		...
		document.write ("Inside Elabel 1  " );
		document.write ("Inside Elabel 2 " + point);
		document.write ("Inside Elabel 3  " + html);
		document.write ("Inside Elabel  4 " + classname);
		document.write ("Inside Elabel 5  " + pixelOffset);
		document.write ("Inside Elabel  6 " + percentOpacity);
		document.write ("Inside Elabel  7 " + overlap);
        this.point = point;
        this.html = html;
        document.write ("this.point " + point);
